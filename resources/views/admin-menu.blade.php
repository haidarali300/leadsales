	...
	<div class="container">
		...
		<div class="row">
			<div class="col-12 text-center mt-3">
				<a class="btn btn-color btn-menu mr-2" href="{{route('leads.create')}}" role="button" data-toggle="tooltip" data-placement="left" title="Star a fresh lead, Assing a seller, Assing a supervisor">Create Lead</a>
